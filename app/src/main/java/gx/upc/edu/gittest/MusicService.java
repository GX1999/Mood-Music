...
public class MusicService extends Service {
    ...
    public int onStartCommand(Intent intent,int flags,int startId){
        ...
        emotion=intent.getStringExtra("name");
        System.out.println("传回来的值："+emotion);
        ...
        public void play() {
            try {
                ...
                */
                ...
                list=am.list(em1);
                if(s=="") {
                    AssetFileDescriptor afd = am.openFd(em1 + list[index]);
                    ...
                    name=s;
                    AssetFileDescriptor afd = am.openFd(em1 + s+".mp3");
                    player.setDataSource(afd.getFileDescriptor(), afd.getStartOffset(), afd.getLength());
                    player.prepare();
                    player.start();
