            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean
                ...
                emotion=intent1.getStringExtra("emotion");
                 ...
                 //   Toast.makeText(ServiceActivity.this," "+progress+save,Toast.LENGTH_SHORT).show();
                    ...
                    resID = getResources().getIdentifier(musicControl.name, "drawable","gx.upc.edu.gittest");
            ...
            case R.id.btn_save:
                if(musicControl.name!=null) {
                    if (helper.findname(musicControl.name)==false) {//收藏，图标变化，加到List中
                        ...
                        if(helper.insert(musicControl.name,musicControl.em1,String.valueOf(a))==true)
